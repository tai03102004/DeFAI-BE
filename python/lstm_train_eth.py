...
def train_lstm_model(csv_file):
    ...
    model.save("python/models/lstm_eth_model.keras")
    joblib.dump(scaler, "python/models/scaler_eth.save")
    print("Model saved as 'lstm_eth_model.keras'")
    print("Scaler saved as 'scaler_eth.save'")

    np.save("python/models/scaled_data_eth.npy", scaled_data)
    print("Scaled data saved as 'scaled_data_eth.npy'")
...
if __name__ == "__main__":
    ...
    try:
        # Train the model
        model, scaler, scaled_data, feature_names = train_lstm_model("python/data/ETH.csv")
